...
export const experience = [
  {
    ...
    highlights: [
      ...
      'Developed AI-powered Clinical Decision Support (CDS) features using LLM integrations to assist providers with evidence-based recommendations.',
      'Implemented Stripe payment gateway and Zoom API integrations for telehealth workflows and Clinical Supervision Systems.',
